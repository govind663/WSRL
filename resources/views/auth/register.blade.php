...
<head>
    ...
    <!-- Meta Description -->
    <meta name="description" content="Register Admin">

    <!-- Meta Keyword-->
    <meta name="keywords" content="Admin, Register">
    ...
    <!-- Open Graph Meta -->
    <meta property="og:title" content="Admin || Register">
    <meta property="og:description" content="Register Admin">
    ...
    <meta name="twitter:title" content="Admin || Register">
    <meta name="twitter:description" content="Register Admin">
        ...
        <div class="row">
            ...
            <div class="col-xl-7 p-0">
                <div class="login-card login-dark">
                    <div>
                        <div>
                            <a class="logo text-start" href="{{ route('admin.register') }}">
                        ...
                        <div class="login-main">
                            <form class="theme-form" method="POST" action="{{ route('admin.register.store') }}" enctype="multipart/form">
                                @csrf
                                <h4>{{ __('Create your account') }}</h4>
                                {{-- <p>{{ __('Enter your personal details to create account') }}</p> --}}

                                <div class="form-group">
                                    <label class="col-form-label"><b>{{ __('Username') }} : <span class="text-danger">*</span></b></label>
                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" autocomplete="name" placeholder="Enter Username">
                                    @error('name')
