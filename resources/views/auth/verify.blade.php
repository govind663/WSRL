                        ...
                        <td>
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" style="max-width:670px;background:#fff; border-radius:3px; text-align:center;-webkit-box-shadow:0 6px 18px 0 rgba(0,0,0,.06);-moz-box-shadow:0 6px 18px 0 rgba(0,0,0,.06);box-shadow:0 6px 18px 0 rgba(0,0,0,.06);">
                                ...
                                <td style="text-align:center;">
                                    <img width="200" height="120" src="https://jyeshthabuddy.com/public/assets/frontend/images/logo.jpg" title="logo" alt="logo">
                                </td>
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        style="background:#4d8d45d4;text-decoration:none !important; font-weight:500; margin-top:35px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;">Reset
                                           Your  Password</a>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <p
                                ...
                                &copy; <strong><a href="https://jyeshthabuddy.com/" title="logo" target="_blank">|| Jyeshtha Buddy ||</a></strong>
                            </p>
                        </td>
                    </tr>
                    <tr>
