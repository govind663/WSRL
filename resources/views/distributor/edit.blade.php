        ...
        <form method="POST" action="{{ route('distributor.update', $distributor->id) }}" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-4 col-md-4">
                        <input type="text" maxlength="6" name="postal_code" id="postal_code" class="form-control @error('postal_code') is-invalid @enderror" value="{{ $distributor->postal_code }}" placeholder="Enter Postal Code.">
                        @error('postal_code')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-12 col-md-12">
                        <textarea type="text" name="address" id="address" class="textarea_editor form-control @error('address') is-invalid @enderror" value="{{ $distributor->address }}" placeholder="Enter Address.">{!! $distributor->address !!}</textarea>
                        @error('address')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
