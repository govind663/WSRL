            ...
            <div class="pd-20 card-box mb-30">
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-4 col-md-4">
                        <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ $product->name }}" placeholder="Enter Title.">
                        @error('name')
                    ...
                    <div class="col-sm-4 col-md-4">
                        ...
                        <img src="{{url('/')}}/bhairaav/product/image/{{ $product->image }}" alt="{{ $product->image }}" width="50%" height="50">
                        @endif
                        <br>
                ...
                <div class="form-group row mt-3">
                    <label class="col-sm-2"><b>Total Quantity : <span class="text-danger">*</span></b></label>
                    <div class="col-sm-4 col-md-4">
                        <input type="text" name="total_quantity" id="total_quantity" class="form-control @error('total_quantity') is-invalid @enderror" value="{{ $product->total_quantity }}" placeholder="Enter Total Quantity.">
                    ...
                    <div class="col-sm-4 col-md-4">
                        <input type="text" name="price" id="price" class="form-control @error('price') is-invalid @enderror" value="{{ $product->price }}" placeholder="Enter Price.">
                        @error('price')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
