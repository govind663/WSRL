                    ...
                    <div class="col-sm-4 col-md-4">
                        <select name="department_id" id="department_id" class="custom-select2 form-control @error('department_id') is-invalid @enderror">
                            ...
                            <optgroup label="Department">
                                <option value="1" {{ old('department_id') == 1 ? 'selected' : '' }}>Super Admin</option>
                                <option value="2" {{ old('department_id') == 2 ? 'selected' : '' }}>Packaging Department</option>
                                <option value="3" {{ old('department_id') == 3 ? 'selected' : '' }}>Dispatch Department</option>
                            </optgroup>
                        </select>
                        @error('department_id')
                            <span class="invalid-feedback" role="alert">
